...
import { PenTool, Layers, Diamond, Eye } from 'lucide-react';

const BrandArchitecture = () => {
    return (
        <AnimatedPage>
            <SEO title="Brand Architecture" canonicalUrl="/services/marketing/brand-architecture" />
                ...
                <div className="container" style={{ position: 'relative', zIndex: 1, maxWidth: '1000px', margin: '0 auto', textAlign: 'center' }}>
                    <motion.div variants={fadeUpVariant}>
                        <span className="label-mono text-accent" style={{ background: 'rgba(255,206,59,0.1)', padding: '0.5rem 1.5rem', borderRadius: '100px', marginBottom: '2rem', display: 'inline-flex', alignItems: 'center', gap: '0.5rem', border: '1px solid rgba(255,206,59,0.2)' }}>
                            <PenTool size={14} /> PERFORMANCE MARKETING
                        </span>

                        <h1 style={{ fontSize: 'clamp(3rem, 7vw, 7rem)', lineHeight: 0.9, letterSpacing: '-0.04em', margin: '0 0 2rem 0', textTransform: 'uppercase' }}>
                            Brand <br />
                            <span style={{ color: 'transparent', WebkitTextStroke: '2px var(--accent)' }}>Architecture.</span>
                        </h1>

                        <p style={{ fontSize: '1.25rem', color: 'var(--text-secondary)', lineHeight: 1.6, maxWidth: '800px', margin: '0 auto 4rem auto' }}>
                            Premium visual identities that command authority. First impressions dictate Enterprise conversions. We engineer brands that instantly convey trust, scale, and technological superiority.
                        </p>
                    </motion.div>
                </div>
            </section>
            ...
            <section className="container" style={{ padding: '8rem 0' }}>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '1.5rem', gridAutoRows: 'minmax(300px, auto)' }}>
                    ...
                    >
                        ...
                        <h3 style={{ fontSize: '2.5rem', marginBottom: '1rem', letterSpacing: '-0.02em' }}>Visual Systems</h3>
                        <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', maxWidth: '500px', lineHeight: 1.6 }}>
                            From logos to complete design guidelines, typography scaling, and component libraries. Your brand must remain flawlessly consistent across every touchpoint.
                        </p>
                    </motion.div>
                    ...
                    >
                        <div>
                            <div className="label-mono" style={{ background: 'rgba(0,0,0,0.1)', padding: '0.4rem 1rem', borderRadius: '100px', display: 'inline-block', marginBottom: '2rem', fontWeight: 600 }}>Awwwards Caliber</div>
                            <h3 style={{ fontSize: '2rem', marginBottom: '1rem', letterSpacing: '-0.02em', color: 'var(--bg-primary)' }}>Premium Positioning</h3>
                        </div>
                        <p style={{ fontSize: '1.1rem', margin: 0, color: 'rgba(0,0,0,0.8)', fontWeight: 500, lineHeight: 1.6 }}>
                            Aesthetic minimalism paired with deep psychological impact to ensure you look like the most expensive, capable option in your market.
                        </p>
                    </motion.div>
            ...
            <section style={{ padding: '8rem 0' }}>
                <LeadMagnetCTA text="Upgrade Your Identity" variant="primary" />
            </section>
        </AnimatedPage>
    );
};
